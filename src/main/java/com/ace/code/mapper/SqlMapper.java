...
/**
 * MyBatis通用EntityMapper执行SQL工具 <br>
 * 参考地址：http://git.oschina.net/free/EntityMapper
 * @author Diliang.Li
 * @since 2017-03-18
 */
        ...
        private void newSelectMappedStatement(String msId, SqlSource sqlSource, final Class<?> resultType) {
            MappedStatement ms = new MappedStatement.Builder(configuration, msId, sqlSource, SqlCommandType.SELECT)
                    .resultMaps(new ArrayList<ResultMap>() {
						 ...
						 * 
						 */
						private static final long serialVersionUID = 6838756020829851978L;
        ...
        private void newUpdateMappedStatement(String msId, SqlSource sqlSource, SqlCommandType sqlCommandType) {
            MappedStatement ms = new MappedStatement.Builder(configuration, msId, sqlSource, sqlCommandType)
                    .resultMaps(new ArrayList<ResultMap>() {
						 ...
						 * 
						 */
						private static final long serialVersionUID = -5422892517104323861L;
